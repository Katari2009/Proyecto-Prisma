        ...
        activities: [
            {
                ...
                content: {
                    questions: [
                        ...
                        {
                            question: "Considera el conjunto de datos: 3, 5, 8, 10, 12, 15, 18. ¿Cuál es el valor del primer cuartil (Q1)?",
                            options: ["3", "5", "8", "9", "10"],
                            answer: "5",
                            explanation: "Hay 7 datos (n=7). La posición del primer cuartil (Q1) se calcula como (n+1)/4. En este caso, (7+1)/4 = 2. Por lo tanto, Q1 es el segundo valor en el conjunto de datos ordenado, que es 5."
                        },
                        {
