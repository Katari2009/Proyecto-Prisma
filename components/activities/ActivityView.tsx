...
const ActivityView: React.FC<ActivityViewProps> = ({ moduleId, activityId, onComplete, onGoHome }) => {
    ...
    return (
        <div className="animate-fade-in max-w-4xl mx-auto">
            <button onClick={onGoHome} className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors mb-4 font-semibold">
